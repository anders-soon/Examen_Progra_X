    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseFacebookAuthentication(
               appId: "1846566795449739",
               appSecret: "68560733aea8b3f56a24ed63c6bf53e2");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "137290856444-fvivpkai58u9ote515jvjnmoflih3rqe.apps.googleusercontent.com",
                ClientSecret = "DgWsgTTPTn2Kc2xgOdRV5A9H"
            });
        }
    }
}